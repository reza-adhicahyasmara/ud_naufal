...
class Penjualan extends CI_Controller {
    ...
    function index() {
        ...
        if($id_karyawan != null && $hak_akses == 'Pemilik'){
            ...
            $this->load->view("backend/pemilik/penjualan/body",$data);
        }  
        else{ 
            redirect('login');
        }  
    ...
    function detail($kode_penjualan){
        ...
        if($id_karyawan != null && $hak_akses == 'Pemilik'){
            ...
            $this->load->view("backend/pemilik/penjualan/body_detail",$data);
        }
        else{ 
            redirect('login');
        }  
    ...
    function load_data_item_penjualan(){
        ...
        $data['list_produk'] = $this->Mod_transaksi->get_item_penjualan($kode_penjualan);
        $this->load->view('backend/pemilik/penjualan/load_data_item_penjualan', $data);
    }
}