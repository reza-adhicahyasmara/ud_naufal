...
<section id="portfolio-details" class="portfolio-details">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            ...
            <span class="text-bold fs-6"><?php echo $data_detail['kode_penjualan']; ?></span>
        </div>
    </div>
    <hr>
    <div class="row mb-3">
            ...
            <table class="table-borderless">
                ...
                <thead>
                    <tr>
                        ...
                        <td style="width: 5%; vertical-align: top;"><small>:</small></td>
                        <td style="vertical-align: top;"><small><?php echo $data_detail['nama_penjualan']; ?></small></td>
                    </tr>
                    <tr>
                        <th id="" style="width: 30%; vertical-align: top;"><small>Tanggal</small></th>
                        <td style="width: 5%; vertical-align: top;"><small>:</small></td>
                        <td style="vertical-align: top;"><small><?php echo $data_detail['tanggal_penjualan']; ?></small></td>
                    </tr>
                    <tr>
                        <th id="" style="width: 30%; vertical-align: top;"><small>No. Kontak</small></th>
                        <td style="width: 5%; vertical-align: top;"><small>:</small></td>
    ...
    <table style="width:100%" id="datatable_admin" class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-sm" style="text-align: right; vertical-align: middle;"><?php echo number_format($item->qty_ipenjualan, 0, ".", ".")." ".$item->satuan_produk;?></td>
                <td class="text-sm" style="text-align: right; vertical-align: middle;"><?php echo "Rp ".number_format($item->harga_ipenjualan, 0, ".", ".");?></td>
                <td class="text-sm" style="text-align: right; vertical-align: middle;"><?php echo "Rp ".number_format($item->subtotal_ipenjualan, 0, ".", ".");?></td>
            </tr>
            <?php      
                    $jumlah_produk += 1; 
                }
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-sm" style="text-align: right; vertical-align: middle;"><?php echo "Rp ".number_format($data_detail['total_penjualan'], 0, ".", ".");?></td>
            </tr>
        </tfoot>
    </table>
    <hr>
    ...
    <div class="row mb-3">
        <div class="col-6 mb-3">
            ...
            <table class="table-borderless">
                ...
                <thead>
                    <tr>
                        <th id="" style="width: 35%; vertical-align: top;"><small>Total Belanja</small></th>
                        <td style="width: 5%; vertical-align: top;"><small>:</small></td>
                        <td style="vertical-align: top;"><small><?php echo "Rp. ".number_format($data_detail['total_penjualan'], 0, ".", "."); ?></td>
                    </tr>
                    <tr>
                        <th id="" style="width: 35%; vertical-align: top;"><small>Cash</small></th>
                        <td style="width: 5%; vertical-align: top;"><small>:</small></td>
                        <td style="vertical-align: top;"><small><?php echo "Rp. ".number_format($data_detail['cash_penjualan'], 0, ".", "."); ?></td>
                    </tr>
                    <tr>
                        <th id="" style="width: 35%; vertical-align: top;"><small>Atas Nama</small></th>
                        <td style="width: 5%; vertical-align: top;"><small>:</small></td>
                        <td style="vertical-align: top;"><small><?php echo "Rp. ".number_format($data_detail['cash_penjualan'] - $data_detail['total_penjualan'], 0, ".", "."); ?></td>
                    </tr>
                </thead>
            </table>
        </div>
