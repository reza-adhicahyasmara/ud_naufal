            ...
            <div class="row">
                ...
                <div class="col-sm-6 float-sm-right">
                    <ol class="breadcrumb float-sm-right m-2">
                        <button type="button" class="btn btn-info" id="btn_tambah_rekening"><span class="bx bx-fw bx-plus"></span> Tambah Data </a>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btn_simpan_rekening" class="btn btn-info"><span class="bx bx-fw bx-save"></span> Simpan</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var url_rekening =  "<?php echo base_url('distributor/rekening'); ?>";
    var url = url_rekening ;
...
<script type="text/javascript">
	...
	function load_data_rekening(){
		$.ajax({
			method : "GET",
			url : '<?php echo base_url('distributor/rekening/load_data_rekening'); ?>',
			beforeSend : function(){
    ...
    $('#btn_tambah_rekening').on("click",function(){
        var url = "<?php echo base_url('distributor/rekening/form_tambah_rekening'); ?>";
    ...
    $(document).on('click', '.btn_edit_rekening', function(e) {
        ...
        var url = "<?php echo base_url('distributor/rekening/form_edit_rekening'); ?>";
        ...
        $('#btn_simpan_rekening').on("click",function(){
            $('#form_rekening').validate({
                ...
                submitHandler: function() {
                    $.ajax({
                        url : '<?php echo base_url('distributor/rekening/tambah_edit_rekening'); ?>',
                        method: 'POST',
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        url: '<?php echo base_url('distributor/rekening/hapus_rekening'); ?>',
                        method: 'POST',
