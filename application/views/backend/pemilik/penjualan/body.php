                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;" >
                                    <a class='btn btn-info btn-sm btn-rounded' href="<?php echo base_url('pemilik/penjualan/detail/'.$row->kode_penjualan); ?>"><i class="bx bx-fw bx-show-alt"></i></a>
                                </td>
                            </tr>
                            <?php 
                                    $no++;
...
<script type="text/javascript">
    var url_outlet =  "<?php echo base_url('pemilik/penjualan'); ?>";
    var url = url_outlet ;
